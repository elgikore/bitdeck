...
namespace BitDeck.Experiments.AudioVisualizerTest;

public partial class AudioVisualizerTest : Window
{
    // VLC specific
    ...
    [
        new()
        {
            ...
            LineStyle = new LineStyle() {AntiAlias = false, Width = 1}
        },
        new()
        {
            Position = 0, 
    ...
    public AudioVisualizerTest()
    {
        ...
        barPlot.ValueLabelStyle.AntiAliasText = false;
        barPlot.ValueLabelStyle.AntiAliasBackground = false;
        barPlot.ValueLabelStyle.SubpixelText = false;
        ...
        // _livePlot.LineWidth = 4;
        
        // Anti-alias
        _livePlot.LineStyle = new LineStyle()
        {
            AntiAlias = false, Width = 4, Color = new Category10().GetColor(0)
        };
